        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-3"><a class="nav-link" href="usuario.php">Torras</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section id="produtos" class="container my-5">
        ...
        <div class="row mt-4 align-items-center">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-6">
                        <img src="images/modelo3dFrente.jpeg" alt="Futuro 1" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="images/modelo3dLado.jpeg" alt="Futuro 2" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4 align-items-center">
            <div class="col-md-5 position-sticky " style="top: 0;">
                <div class="p-3">
                    <img src="images/logoMichelangelo.png" alt="Futuro 1" class="img-fluid rounded">
                </div>
            </div>
            <div class="col-md-7">
                <div class="row">
